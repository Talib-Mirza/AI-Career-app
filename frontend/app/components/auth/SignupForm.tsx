      ...
      <div className="w-full max-w-md mx-auto">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted">Click the link in the email to verify your account and sign in.</p>
          </div>
          <Link href="/auth/login" className="inline-block text-sm font-medium text-foreground hover:underline">
            Back to login
          </Link>
        </div>
      </div>
